...
from git_rank.models.basic_statistics import (
    BasicStatistics,
...
class StatisticsAnalyzer:
    def __init__(
        self, git_local_service: GitLocalService, linter_service: LinterService
    ):
    ...
    def _lint_file(
        self, commit: Commit, file: PathLike, technology: TechnologyType
    ) -> None:
